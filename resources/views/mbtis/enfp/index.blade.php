...
@section('container')
    <div class="w-11/12 pt-12 mx-auto">
        <div class="text-right pt-8">
            <a href="{{route('mbtis.enfp.create')}}"><i class="xi-pen pr-1"></i><button class="">글쓰기</button></a>
        </div>
        <div class="mt-16 min-h-30">
            ...
            @foreach($mbtis as $mbti)
                <tr class="border-b">
                    ...
                    <td class="text-lg truncate"><a href="{{route('mbtis.enfp.show', $mbti->id)}}">{{$mbti->title}}</a></td>

    ...
    <div class="flex pt-8 mx-auto min-h-full">
        <div class="w-full">
            <div class="flex flex-row text-base pt-8 px-8 pb-4">
                <a href="{{route('info', auth()->user()->id)}}" class="mr-2"><button class="hover:text-green-800
                bg-green-my text-gray-50 px-1 py-1 rounded-md">회원정보</button></a>
                <a href="{{route('user.post', auth()->user()->id)}}" class="mr-2"><button class="hover:text-green-800
                bg-green-my text-gray-50 px-1 py-1 rounded-md">작성 게시글</button></a>
                <a href="{{route('user.comment', auth()->user()->id)}}"><button class="hover:text-green-800
                bg-green-my text-gray-50 px-1 py-1 rounded-md">작성 댓글</button></a>
            </div>
